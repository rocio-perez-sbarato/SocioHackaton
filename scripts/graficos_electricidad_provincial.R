...
ggsave("porcentaje_de_escuelas_por_provincia_tipo_electricidad.png", width = 8, height = 8, dpi = 300, bg = "white")
...
# Guardar el gráfico con ggsave
ggsave("porcentaje_de_escuelas_por_provincia_tipo_electricidad_extranjeros.png", width = 8, height = 8, dpi = 300, bg = "white")
...
# Guardar el gráfico con ggsave
ggsave("porcentaje_de_escuelas_por_provincia_tipo_electricidad_sin_extranjeros.png", width = 8, height = 8, dpi = 300, bg = "white")
